...
{{--            <a href="/operate?platform_id={{ Request::input('platform_id') }}&date=today" class="layui-btn layui-btn-sm {{ Request::input('date') == 'today' ? '' : 'layui-btn-primary' }}">今天</a>--}}
        ...
        <div class="layui-inline layui-form-item" style="margin-top: -16px; margin-bottom: 0; margin-left: 30px;">
            <a href="{{ route('operate.add') }}" class="layui-btn">添加运营数据</a>
        </div>
    </div>
        ...
        <div class="layui-form layui-form-pane">
            ...
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="valid_sum" autocomplete="off" class="layui-input sums-total" value="{{ $dhyxsl }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $dhyxslzz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $dhyxsljz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $dhyxslqk }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $dhyxsljc }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $dhyxsljy }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
            ...
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $dhyxsl }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $dhyxsljz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $dhyxslzz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $dhyxslqk }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $dhyxsljc }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $dhyxsljy }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ chance($dhyxsl, $dhsl) }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ chance($dhyxsljz, $dhsljz) }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ chance($dhyxslzz, $dhslzz) }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ chance($dhyxslqk, $dhslqk) }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ chance($dhyxsljc, $dhsljc) }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ chance($dhyxsljy, $dhsljy) }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
        ...
        <div class="layui-form layui-form-pane">
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $jdsl }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdslzz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdsljz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdslqk }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdsljc }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdsljy }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">有效数量</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $jdyxsl }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdyxslzz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdyxsljz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdyxslqk }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdyxsljc }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $jdyxsljy }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
        ...
        <div class="layui-form layui-form-pane">
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $lzsl }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzslzz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzsljz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzslqk }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzsljc }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzsljy }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">有效数量</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" name="number" autocomplete="off" class="layui-input" value="{{ $lzyxsl }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">种植</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzyxslzz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">矫正</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzyxsljz }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">全科</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzyxslqk }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">检查</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzyxsljc }}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width: 80px; padding-left: 0; padding-right: 0; color: red;">洁牙</label>
                    <div class="layui-input-inline" style="width: 80px;">
                        <input type="text" autocomplete="off" class="layui-input" value="{{ $lzyxsljy }}" disabled>
                    </div>
                </div>
            </div>
            <div class="layui-inline" style="width: 175px;">
